package id.sch.smktelkom_mlg.www.recyclerview1;
...
import id.sch.smktelkom_mlg.www.recyclerview1.adapter.HotelAdapter;
import id.sch.smktelkom_mlg.www.recyclerview1.model.Hotel;

public class MainActivity extends AppCompatActivity {
    ArrayList<Hotel> mList = new ArrayList<>(); HotelAdapter mAdapter;
    ...
    private void fillData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.places); String[]
        ...
        for (int i = 0; i < arFoto.length; i++) {
            ...
            ((RoundedBitmapDrawable) rbd).setCircular(true);
            arFoto[i] = rbd;
        }
        a.recycle();
